...
#include "interfaces/msg/detail/motion_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::MotionCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::MotionCommand & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::MotionCommand;
    is_plain =
      (
      offsetof(DataType, body_height) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const interfaces::msg::MotionCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::MotionCommand *>(
    untyped_ros_message);
...
get_message_type_support_handle<interfaces::msg::MotionCommand>()
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_MotionCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, MotionCommand)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_MotionCommand__handle;
}
