...
#include "interfaces/msg/detail/motor_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::MotorCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::MotorCommand & ros_message)
{
  // Member: torque
  cdr >> ros_message.torque;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::MotorCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::MotorCommand *>(
    untyped_ros_message);
...
get_message_type_support_handle<interfaces::msg::MotorCommand>()
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, MotorCommand)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
