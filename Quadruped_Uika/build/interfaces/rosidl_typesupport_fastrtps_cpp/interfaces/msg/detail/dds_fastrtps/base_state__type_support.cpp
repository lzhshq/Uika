...
#include "interfaces/msg/detail/base_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::BaseState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::BaseState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::BaseState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::BaseState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::BaseState *>(
    untyped_ros_message);
...
get_message_type_support_handle<interfaces::msg::BaseState>()
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_BaseState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, BaseState)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_BaseState__handle;
}
