...
struct RobotState_
{
  ...
  using _motor_state_type =
    std::vector<robot_msgs::msg::MotorState_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<robot_msgs::msg::MotorState_<ContainerAllocator>>>;
  ...
  Type & set__motor_state(
    const std::vector<robot_msgs::msg::MotorState_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<robot_msgs::msg::MotorState_<ContainerAllocator>>> & _arg)
  {
