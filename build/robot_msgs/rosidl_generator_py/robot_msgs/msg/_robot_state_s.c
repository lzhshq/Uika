...
bool robot_msgs__msg__robot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // motor_state
    ...
    if (!robot_msgs__msg__MotorState__Sequence__init(&(ros_message->motor_state), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create robot_msgs__msg__MotorState__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    robot_msgs__msg__MotorState * dest = ros_message->motor_state.data;
