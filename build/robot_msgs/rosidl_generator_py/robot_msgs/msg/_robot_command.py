...
class RobotCommand(metaclass=Metaclass_RobotCommand):
    ...
    _fields_and_field_types = {
        'motor_command': 'sequence<robot_msgs/MotorCommand>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['robot_msgs', 'msg'], 'MotorCommand')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.motor_command = kwargs.get('motor_command', [])
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.motor_command != other.motor_command:
            return False
        return True
    ...
    def motor_command(self):
        """Message field 'motor_command'."""
        return self._motor_command

    @motor_command.setter
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, MotorCommand) for v in value) and
                 True), \
                "The 'motor_command' field must be a set or sequence and each value of type 'MotorCommand'"
        self._motor_command = value
