...
#include "robot_msgs/msg/detail/robot_command__type_support.h"
...
static const _RobotCommand_type_support_symbol_names_t _RobotCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_msgs, msg, RobotCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_msgs, msg, RobotCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_msgs, msg, RobotCommand)() {
  return &::robot_msgs::msg::rosidl_typesupport_c::RobotCommand_message_type_support_handle;
}
