...
{
  const auto * member = reinterpret_cast<const std::vector<robot_msgs::msg::MotorState> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<robot_msgs::msg::MotorState> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<robot_msgs::msg::MotorState> *>(untyped_member);
  return &member[index];
}

void fetch_function__RobotState__motor_state(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const robot_msgs::msg::MotorState *>(
    get_const_function__RobotState__motor_state(untyped_member, index));
  auto & value = *reinterpret_cast<robot_msgs::msg::MotorState *>(untyped_value);
  value = item;
}

void assign_function__RobotState__motor_state(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<robot_msgs::msg::MotorState *>(
    get_function__RobotState__motor_state(untyped_member, index));
  const auto & value = *reinterpret_cast<const robot_msgs::msg::MotorState *>(untyped_value);
  item = value;
}

void resize_function__RobotState__motor_state(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<robot_msgs::msg::MotorState> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotState_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__RobotState__motor_state,  // fetch(index, &value) function pointer
    assign_function__RobotState__motor_state,  // assign(index, value) function pointer
    resize_function__RobotState__motor_state  // resize(index) function pointer
  }
};
