...
def generate_launch_description():
  ...
  node1 = Node(
    ...
    parameters= [
            ...
            {'extrinsic_pitch': 0.0},
            {'extrinsic_yaw': 0.0},
            {'self_filtering_box.min_x': 0.0},
            {'self_filtering_box.max_x': 0.0},
            {'self_filtering_box.min_y': 0.0},
            {'self_filtering_box.max_y': 0.0},
            {'self_filtering_box.min_z': 0.0},
            {'self_filtering_box.max_z': 0.0},
    ]
  )
